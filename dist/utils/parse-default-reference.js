 ...
 */
function hasDefaultPath(reference) {
 ...
 */
function getReferencePrefix(attributePath) {
 ...
 */
function getReferenceSufix(reference) {
 ...
 */
function parseDefaultReference(attributePath, reference) {
...
exports.default = parseDefaultReference;
//# sourceMappingURL=parse-default-reference.js.map